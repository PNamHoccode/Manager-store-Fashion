...
public class NhanVienJdialogg extends javax.swing.JDialog {
    ...
    public static final Logger logger = Logger.getLogger(NhanVienJdialogg.class);
                ...
                if (nv != null) {
                    ...
                    if (confirm.equals(model.getMatKhau())) {
                        try {
                          ...
                          //  logger.info("Người dùng " + Auth.user.getMaNV() + "thao tác thêm thành công nhân viên " + Hoten);
        ...
        if (!Auth.isManager()) {
            ...
            if (manv.equals(maNVDangNhap)) {
                ...
                try {
                    ...
                    logger.info("Người dùng " + Auth.user.getMaNV() + "thao tác xóa thành công nhân viên " + Hoten);
                } catch (Exception e) {
                    MsgBox.alert(this, "Xóa thất bại!");
                     logger.warn("Người dùng " + Auth.user.getMaNV() + "thao tác xóa thành công nhân viên " + Hoten);
                }
            }
        }
    }
